...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='assigned_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag_assignments_made', to='users.customuser'),
        ),
        migrations.AddField(
            model_name='contacttagassignment',
            name='contact',
        ...
        migrations.AddField(
            model_name='contacttagassignment',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contact_assignments', to='contacts.contacttag'),
        ),
        migrations.AddField(
            model_name='contacttag',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contact_tags_created', to='users.customuser'),
        ),
        migrations.AddField(
            model_name='contact',
            name='company',
        ...
        migrations.AddField(
            model_name='contact',
            name='owner',
            field=models.ForeignKey(help_text='User who owns this contact', on_delete=django.db.models.deletion.CASCADE, related_name='owned_contacts', to='users.customuser'),
        ),
        migrations.AddField(
            model_name='contact',
            name='updated_by',
